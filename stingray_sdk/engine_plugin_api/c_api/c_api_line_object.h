...
struct LineObjectCApi
{
	...
	void	(*add_box) (LineObjectPtr, ConstVector4Ptr color, ConstMatrix4x4Ptr pose, float legacy_unused_parameter__radius, ConstVector3Ptr half_extents);
	...
	void	(*add_unit_meshes) (LineObjectPtr, uint64_t unit_resource_name_id64, const char *optional_debug_unit_resource_name, ConstVector4Ptr color, ConstMatrix4x4Ptr pose, ConstVector3Ptr optional_camera_direction, unsigned optional_mesh_name);
};
